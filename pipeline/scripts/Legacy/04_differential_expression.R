...
# - 04_differential_expression_no_harmony.R (recommended)
# - 04_differential_expression_harmony.R
#
# These versions have improved volcano plots and separate output directories.
################################################################################

cat("\n")
cat("================================================================\n")
cat("⚠️  WARNING: This script is DEPRECATED\n")
cat("================================================================\n")
cat("\n")
cat("Please use one of the improved versions instead:\n")
cat("  - 04_differential_expression_no_harmony.R (recommended)\n")
cat("  - 04_differential_expression_harmony.R\n")
cat("\n")
cat("Improvements in new versions:\n")
cat("  ✓ Beautiful volcano plots with better colors\n")
cat("  ✓ Separate output directories (no conflicts)\n")
cat("  ✓ Smart gene labeling (top genes only)\n")
cat("  ✓ Fixed heatmap warnings\n")
cat("\n")
cat("To run:\n")
cat("  sbatch scripts/04_differential_expression_no_harmony.sh\n")
cat("  sbatch scripts/04_differential_expression_harmony.sh\n")
cat("\n")
cat("See DIFF_EXPRESSION_IMPROVEMENTS.md for details.\n")
cat("================================================================\n")
cat("\n")

# Stop execution
stop("Please use the updated scripts. This script is no longer maintained.")
