################################################################################
# Script: 04_differential_expression_no_harmony.R
# Description: Differential expression analysis between KO and WT conditions
# Input: No-Harmony integrated Seurat object from step 03
...
OUTPUT_DIR <- "results/diff_expression/no_harmony"
dir.create(file.path(OUTPUT_DIR, "plots"), recursive = TRUE, showWarnings = FALSE)
dir.create(file.path(OUTPUT_DIR, "tables"), recursive = TRUE, showWarnings = FALSE)

cat("\n================================================================\n")
cat("Differential Expression Analysis: KO vs WT (No-Harmony Version)\n")
cat("================================================================\n")
...
################################################################################
cat("Step 1: Loading No-Harmony integrated Seurat object...\n")
cat("----------------------------------------------------------------\n")

seurat_obj <- readRDS("results/clustering/no_harmony/seurat_integrated.rds")
...
p1 <- EnhancedVolcano(global_degs,
                     ...
                     title = 'KO vs WT (All Cells - No Harmony)',
...
p6 <- ggplot(cluster_deg_melt, aes(x = cluster, y = value, fill = variable)) +
      ...
      theme_minimal() +
      ggtitle("DEG Counts by Cluster (No Harmony)") +
      xlab("Cluster") +
      ylab("Number of DEGs") +
...
cat("\n================================================================\n")
cat("Differential Expression Analysis Complete (No Harmony)\n")
cat("================================================================\n")
